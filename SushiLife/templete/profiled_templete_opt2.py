...
profiler_init.dump_stats("init_profile_opt2.prof")
profiler_loop.dump_stats("loop_profile_opt2.prof")

print("--- Initialization Profile Stats (opt2) ---")
s_init = io.StringIO()
ps_init = pstats.Stats(profiler_init, stream=s_init).sort_stats('cumulative')
ps_init.print_stats(15)
print(s_init.getvalue())

print("\n--- Main Loop Profile Stats (opt2) ---")
s_loop = io.StringIO()
